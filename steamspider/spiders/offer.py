...
class OfferSpider(Spider):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.page_url = 'https://store.steampowered.com/search/?category1=21,998&specials=1&l=schinese'
    ...
    def parse_page(self,response):
        ...
        logging.info('offer total_apps: %s total_pagenum: %s current_page: %s' % (
